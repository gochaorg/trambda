...
public class TryCatchAnnotation implements ByteCode, AnnVisIdProperty {
    private static final long serialVersionUID = 1;

    public TryCatchAnnotation(){}
    public TryCatchAnnotation(int typeRef, String typePath, String descriptor, boolean visible){
    ...
    public String toString(){
        return TryCatchAnnotation.class.getSimpleName()+
