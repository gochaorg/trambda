...
public class InsnAnnotation implements ByteCode, AnnVisIdProperty {
    private static final long serialVersionUID = 1;

    public InsnAnnotation(){}
    public InsnAnnotation(int typeRef, String typePath, String descriptor, boolean visible){
    ...
    public String toString(){
        return InsnAnnotation.class.getSimpleName()+
