...
Протоколов передачи данных и вызова процедур много, будут рассмотрены известные автору.
Известные протоколы можно разделить на несколько категорий/свойств:
...
- `(*)` 
    ...
    - требуется апробация для "замыканий" в отношении лямбд
...
По скольку проект только начат, говорить о реальном применении рано, 
можно говорит о потенциальном применении
...
- Не реализованы замыкания
- Согласованность типов данных сервера и клиента
- Не реализована поддержка безопасности