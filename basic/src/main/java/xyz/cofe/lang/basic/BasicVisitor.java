...
public interface BasicVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by the {@code LiteralObj}
	 * labeled alternative in {@link BasicParser#atom}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitLiteralObj(BasicParser.LiteralObjContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitCallFun(BasicParser.CallFunContext ctx);
	/**
	 * Visit a parse tree produced by the {@code ObjAccess}
	 * labeled alternative in {@link BasicParser#atom}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitObjAccess(BasicParser.ObjAccessContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link BasicParser#objPostFix}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitObjPostFix(BasicParser.ObjPostFixContext ctx);
	/**
