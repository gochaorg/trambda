...
public interface BasicListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by the {@code LiteralObj}
	 * labeled alternative in {@link BasicParser#atom}.
	 * @param ctx the parse tree
	 */
	void enterLiteralObj(BasicParser.LiteralObjContext ctx);
	/**
	 * Exit a parse tree produced by the {@code LiteralObj}
	 * labeled alternative in {@link BasicParser#atom}.
	 * @param ctx the parse tree
	 */
	void exitLiteralObj(BasicParser.LiteralObjContext ctx);
	/**
	 ...
	 * @param ctx the parse tree
	 */
	void enterCallFun(BasicParser.CallFunContext ctx);
	/**
	 * Exit a parse tree produced by the {@code CallFun}
	 * labeled alternative in {@link BasicParser#atom}.
	 * @param ctx the parse tree
	 */
	void exitCallFun(BasicParser.CallFunContext ctx);
	/**
	 * Enter a parse tree produced by the {@code ObjAccess}
	 * labeled alternative in {@link BasicParser#atom}.
	 * @param ctx the parse tree
	 */
	void enterObjAccess(BasicParser.ObjAccessContext ctx);
	/**
	 * Exit a parse tree produced by the {@code ObjAccess}
	 * labeled alternative in {@link BasicParser#atom}.
	 * @param ctx the parse tree
	 */
	void exitObjAccess(BasicParser.ObjAccessContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link BasicParser#objPostFix}.
	 * @param ctx the parse tree
	 */
	void enterObjPostFix(BasicParser.ObjPostFixContext ctx);
	/**
	 * Exit a parse tree produced by {@link BasicParser#objPostFix}.
	 * @param ctx the parse tree
	 */
	void exitObjPostFix(BasicParser.ObjPostFixContext ctx);
	/**
